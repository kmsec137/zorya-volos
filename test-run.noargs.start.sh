...
GHIDRA_INSTALL_DIR=/snap/ghidra/current/ghidra_12.0_PUBLIC/ zorya $1 --compiler gc --thread-scheduling all-threads --lang go  --no-negate-path-exploration --mode start --arg 'a'
